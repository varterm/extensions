...
### Fixed
- Windows (and Linux via ffplay) can play reads in the background. The Sentry error `Background playback currently uses macOS afplay` was a Windows user hitting that gap.
